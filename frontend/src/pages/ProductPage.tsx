    ...
    useEffect(() => {
        ...
        api
            ...
            .then((res) => {
                ...
                return api.get(`/products?category=${res.data.data.category}`);
            })
            .then((res) => {
                setRelatedProducts(res.data.data.filter((p: Product) => p.id != id));
            })
                ...
                {relatedProducts.length > 0 && (
                    <section className="mt-12 mb-44">
                        <div className="flex items-center justify-between mb-6">
                            <div>
                                <h2 className="text-2xl font-medium text-app-green">
                                    Related Products
                                </h2>
