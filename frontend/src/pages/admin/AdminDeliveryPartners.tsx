...
export default function AdminDeliveryPartners() {
    ...
    const fetchPartners = async () => {
        try {
            ...
            console.log("Fetch delivery-Partners:", data.data)
            setPartners(data.data)
        } catch (error:any) {
            toast.error(error?.response?.data?.message || "Failed to fetch delivey-partners");
        } finally{
            setLoading(false)
        }
    };
    ...
    const handleSubmit = async (e: React.SubmitEvent) => {
        ...
        try {
            ...
            toast.error(error?.response?.data?.message || "Failed to add delivey-partners");
        } finally{
            setSaving(false)
        }
    ...
    const toggleActive = async (id: string, isActive: boolean) => {
        try {
            ...
            toast.error(error?.response?.data?.message || "Failed toggleActive");
        }
